    ...
    if (data == '\r' && bufferIdx > 0)
    {
      ...
      if (str.length() >= 3)
      {
        ...
        if (cmd.equals("609"))
        {
          ...
          Serial.println("Shield Sent: \"" + msg + "\"");
#endif
          smartthing.send(msg);
        }
        // zone closed
        ...
        else if (cmd.equals("621"))
        {
          String msg = "SY:" + cmd;
#ifdef DEBUG_ENABLE
          Serial.println("Fire Key Alarm");
#endif
          smartthing.send(msg);
        }
        else if (cmd.equals("622"))
        {
          String msg = "SY:" + cmd;
#ifdef DEBUG_ENABLE
          Serial.println("Fire Key Alarm Restored");
#endif
          smartthing.send(msg);
        }
        // ready
        ...
        {
#ifdef DEBUG_ENABLE
          String lcdsize = str.substring(6,8);
          int numchars = lcdsize.toInt();
          Serial.print("LCD update: " + str.substring(8,(8+numchars)) + "\n");
          //Serial.println(str);
#endif
        ...
        else if (cmd.equals("842"))
        {
          String msg = "SY:" + cmd;
#ifdef DEBUG_ENABLE
          Serial.println("Fire Trouble Alarm");
#endif
          smartthing.send(msg);
        }
        else if (cmd.equals("843"))
        {
          String msg = "SY:" + cmd;
#ifdef DEBUG_ENABLE
          Serial.println("Fire Trouble Alarm Restored");
#endif
          smartthing.send(msg);
        }
        ...
        else if (cmd.equals("897"))
        {
          ...
          smartthing.send(msg);
           ...
           Serial.println("Unsupported Message \"" + str + "\""); 
           //Serial.println(str);
        }
#endif
      }
...
void alarmArm()
{
  ...
  String cmd = String("0331130100"); //<-------- IMPORTANT: replace * with pin code 
...
void alarmDisarm()
{
  ...
  String cmd = String("0401130100"); //<------- IMPORTANT: replace * with pin code
  cmd = appendChecksum(cmd);
  Serial1.print(cmd);
#ifdef DEBUG_ENABLE
  Serial.print(cmd);
...
void alarmSendCode()
{
  String code = String("2001130100"); //<------- IMPORTANT: replace * with pin code
